export default {
  ...
  about: {
    ...
    aboutAppDescription: 'Safe Zone è un\'app innovativa per monitorare e proteggere le chat dei bambini utilizzando l\'intelligenza artificiale. Aiutiamo i genitori a proteggere i propri figli dalle minacce online mantenendo la privacy e la fiducia.',
    ...
    supportProjectDescription: 'Safe Zone è un progetto open source creato per proteggere i bambini. Se ti piace il progetto, puoi supportarne lo sviluppo:',
    ...
    footer: '© 2024 Safe Zone by KIKU. Tutti i diritti riservati.',
