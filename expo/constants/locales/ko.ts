export default {
  ...
  about: {
    ...
    aboutApp: '앱 정보',
    aboutAppDescription: 'Safe Zone은 인공 지능을 사용하여 자녀의 채팅을 모니터링하고 보호하는 혁신적인 앱입니다. 개인정보 보호와 신뢰를 유지하면서 부모가 자녀를 온라인 위협으로부터 보호하도록 돕습니다.',
    publishUrl: '게시 URL',
    ...
    supportProjectDescription: 'Safe Zone은 자녀를 보호하기 위해 만들어진 오픈 소스 프로젝트입니다. 프로젝트가 마음에 드시면 개발을 지원할 수 있습니다:',
    supportProjectHint: '모든 자금은 프로젝트 개발 및 자녀 안전 개선에 사용됩니다',
    support: '지원',
    supportDescription: '질문이나 제안이 있으시면 문의하세요:',
    email: '이메일: support@safezone-app.com',
    website: '웹사이트: www.safezone-app.com',
    footer: '© 2024 Safe Zone. 모든 권리 보유.',
