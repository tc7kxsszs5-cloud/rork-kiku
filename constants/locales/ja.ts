export default {
  ...
  about: {
    ...
    aboutApp: 'アプリについて',
    aboutAppDescription: 'Safe Zoneは、人工知能を使用して子供のチャットを監視および保護する革新的なアプリです。プライバシーと信頼を維持しながら、親が子供をオンラインの脅威から保護するのを支援します。',
    publishUrl: '公開URL',
    ...
    supportProjectDescription: 'Safe Zoneは、子供を保護するために作成されたオープンソースプロジェクトです。プロジェクトが気に入った場合は、その開発をサポートできます：',
    supportProjectHint: 'すべての資金はプロジェクト開発と子供の安全性向上に使われます',
    support: 'サポート',
    supportDescription: 'ご質問やご提案がございましたら、お問い合わせください：',
    email: 'メール：support@safezone-app.com',
    website: 'ウェブサイト：www.safezone-app.com',
    footer: '© 2024 Safe Zone。全著作権所有。',
