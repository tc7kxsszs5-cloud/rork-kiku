export default {
  ...
  home: {
    ...
    search: 'Search participants and messages...',
    filterAll: 'All',
    filterSafe: 'Safe',
    filterMedium: 'Medium',
    filterHigh: 'High',
  ...
  roleSelection: {
    ...
    parent: 'Parent',
    child: 'Child',
    parentDescription: 'Full control and safety monitoring for your child',
    parentFeature1: 'Monitor all chats and messages',
    parentFeature2: 'Parental control settings',
    parentFeature3: 'Risk and alert notifications',
    parentFeature4: 'Safety statistics and analytics',
    childDescription: 'Safe communication with protection and support',
    childFeature1: 'Safe chats with AI protection',
    childFeature2: 'SOS button for emergency help',
    childFeature3: 'Privacy protection',
    childFeature4: 'Limited access to settings',
    continue: 'Continue',
    saving: 'Saving...',
    selectRoleAlert: 'Please select your role to continue',
  ...
  about: {
    ...
    aboutAppDescription: 'Safe Zone is an innovative app for monitoring and protecting children\'s chats using artificial intelligence. We help parents protect their children from online threats while maintaining privacy and trust.',
    ...
    supportProjectDescription: 'Safe Zone is an open source project created to protect children. If you like the project, you can support its development:',
    ...
    footer: '© 2024 Safe Zone. All rights reserved.',
