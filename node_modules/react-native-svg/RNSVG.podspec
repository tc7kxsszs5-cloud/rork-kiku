...
Pod::Spec.new do |s|
  ...
  # s.visionos.  # Commented for CocoaPods 1.10.2 compatibility
  # exclude_files = '**/*.macos.{h,m,mm}' if s.respond_to?(:visionos)
  s.osx.exclude_files = '**/*.ios.{h,m,mm}'
  s.requires_arc      = true
  s.platforms         = { :osx => "10.14", :ios => "12.4", :tvos => "12.4" }  # :visionos => "1.0" commented for CocoaPods 1.10.2 compatibility
  ...
  # s.visionos.  # Commented for CocoaPods 1.10.2 compatibility
  # resource_bundles  = {'RNSVGFilters' => ['apple/**/*.xros.metallib']}
