...
Pod::Spec.new do |s|
  ...
  s.platforms    = { :ios => min_supported_ios_version, :tvos => min_supported_tvos_version }  # :visionos => min_supported_visionos_version commented for CocoaPods 1.10.2 compatibility
  s.source       = { :git => "https://github.com/software-mansion/react-native-screens.git", :tag => "#{s.version}" }
  s.source_files = source_files
  # s.project_header_files = "ios/bridging/Swift-Bridging.h"  # Commented out for CocoaPods 1.10.2 compatibility
  s.requires_arc = true
  ...
  if new_arch_enabled
    s.subspec "common" do |ss|
      ss.source_files         = ["common/cpp/**/*.{cpp,h}", "cpp/**/*.{cpp,h}"]
        # ss.project_header_files = "common/cpp/**/*.h", "cpp/**/*.h" # Don't expose C++ headers publicly to allow importing framework into Swift files - Commented for CocoaPods 1.10.2 compatibility
