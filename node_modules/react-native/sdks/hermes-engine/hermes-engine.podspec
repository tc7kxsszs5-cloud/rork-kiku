...
Pod::Spec.new do |spec|
  ...
  spec.source      = source
  spec.platforms   = { :osx => "10.13", :ios => "15.1", :tvos => "15.1" }  # :visionos => "1.0" commented for CocoaPods 1.10.2 compatibility
  ...
  # spec.visionos.  # Commented for CocoaPods 1.10.2 compatibility
  ...
  if HermesEngineSourceType::isPrebuilt(source_type) then
    ...
    spec.subspec 'Pre-built' do |ss|
      ...
      # ss.visionos.vendored_frameworks = "destroot/Library/Frameworks/universal/hermes.xcframework"  # Commented for CocoaPods 1.10.2 compatibility
