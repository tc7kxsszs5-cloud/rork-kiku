...
class ReactNativePodsUtils
    ...
    def self.check_minimum_required_xcode(xcodebuild_manager: Xcodebuild)
        ...
        if Gem::Version::new(current) < Gem::Version::new(min_required)
            Pod::UI.warn "React Native requires XCode >= #{min_required}. Found #{current}. Continuing anyway..."
            # raise "Please upgrade XCode"  # Temporarily disabled for Xcode 15.2 compatibility
        end
    end
