-- ============================================
-- Схема базы данных: Система Родитель-Ребенок
-- Версия 1.0
-- ============================================
...
-- Активность родителей (для индикатора онлайн)
...
-- Связь детей с учебными программами
...
-- Мониторинг контента (ссылки, материалы)
...
-- История активности ребенка (для статистики)
...
-- Обновляем существующую таблицу chats для связи с детьми
...
-- Обновляем существующую таблицу messages для связи с детьми
...
-- Обновляем существующую таблицу alerts для связи с детьми
